...
std::shared_ptr<Path> ADDController::calc_path(FVector pos0, FVector vel0, FVector pos1, FVector vel1) {
	DifferentialDrivePaths* dp = new DifferentialDrivePaths(pos0, vel0, pos1, vel1, v_max, map->omega_max);
...
void ADDController::init() {
	...
	RRT rrt(1000, map, std::bind(&ADDController::calc_path, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4), v_max, a_max);
